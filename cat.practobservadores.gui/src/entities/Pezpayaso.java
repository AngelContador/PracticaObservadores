package entities;
/**Aquesta és una subclasse d'animals, Pezpayaso, i hereta els atributs de la superclasse
 */
public class Pezpayaso extends Animals{
    private String especie, habitat, sexo, profundidad, tiemponav, horalleg, cebo, temp, parasito;
    public Pezpayaso(String especie,String habitat,String sexo,String profundidad,String tiemponav,String horalleg,String cebo,String temp,String parasito){
